      ...
      potentialAbility: [
        {
          id: '0',
          title: '自我驱动能力',
          txt: `自我驱动是主动学习状态中最为重要的行为表征之一，我们通过观察孩子在有一定程度动机参与的前提下的自我驱使、不断尝试、克服困境、解决问题等方面的综合能力来评价自我驱动能力。`,
          grade: 'D-',
        },
        {
          id: '1',
          title: '抗挫折能力',
          txt: `目前的孩子因为过度保护、过度表扬及奖励，往往缺乏应对逆境、挫折时应该保有的韧性。而抗压、抗挫折能力，是在应对未来不确定性时最为重要的能力，意志力、毅力等传统的品质，都属于抗挫折能力的子集。`,
          grade: 'c-',
        },
        {
          id: '2',
          title: '有效专注力',
          txt: `影响学习效率的因素除了知识结构、领悟理解能力外，最重要的是有效专注力，因为只有在有效专注的时间内，才能获得最大的学习效能。我们评价有效专注，主要从观察孩子在专注过程中的状态和获得的结果这两大方面展开。`,
          grade: 'B+',
        },
        {
          id: '3',
          title: '思维表征',
          txt: `授人予鱼不如授人予渔。所以相比单纯的知识和技能，我们更在意学习的方法和思维的模式。思维表征是用于描述孩子思维层次的一种方式，我们通过观察孩子表现出的高阶思维能力（归纳、抽象等），来对思维表征进行评测。`,
          grade: 'B-',
        },
      ]
    },
